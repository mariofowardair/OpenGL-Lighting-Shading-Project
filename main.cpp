...
public:
    ...
    void Create_Shining_Scene()
    {
        ...
        auto duck = Add_Obj_Mesh_Object("duck.obj");
        //// set transform
        Matrix4f t3, R;
        R << 1, 0, 0, 0,
			0, 0, 1, -3,
        ...
        t3 << .15, 0., 0., 0.,
            ...
            0., 0., .15, 0.,
            0., 0., 0., 1.;
        duck->Set_Model_Matrix(t3 * R);
        //// set material properties
        duck->Set_Ka(Vector3f(0.05f, 0.02f, 0.03f));
        duck->Set_Kd(Vector3f(0.4f, 0.2f, 0.3f));
        duck->Set_Ks(Vector3f(0.4f, 0.2f, 0.3f));
        duck->Set_Shininess(128.f);
